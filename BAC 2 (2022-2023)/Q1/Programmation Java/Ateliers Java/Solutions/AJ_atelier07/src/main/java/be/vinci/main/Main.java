...
public class Main {
    ...
    public static HttpServer startServer() {
        ...
        // in be.vinci package
        final ResourceConfig rc = new ResourceConfig().packages("be.vinci.api").property("jersey.config.server.wadl.disableWadl",true).register(CORSResponseFilter.class);

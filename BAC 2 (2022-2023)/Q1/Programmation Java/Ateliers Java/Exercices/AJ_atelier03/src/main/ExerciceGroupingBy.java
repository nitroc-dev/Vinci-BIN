...
public class ExerciceGroupingBy {
    ...
    private void groupBy1() {
        ...
        Map<Trader, List<Transaction>> transactionsTrader = transactions
                .stream()
    ...
    private void groupBy2() {
        ...
        Map<Trader, Long> nombresTransactionsTraders = transactions
                .stream()
                .collect(Collectors.groupingBy(Transaction::getTrader, Collectors.counting()));
        System.out.println(nombresTransactionsTraders);
    }


    private void groupBy3() {
        System.out.println("GroupBy3");
        Map<TransactionsLevel, List<Transaction>> transactionsLevel = transactions
                .stream()
                .collect(Collectors.groupingBy(t -> {
                    if (t.getValue() >= 1000) return TransactionsLevel.VERY_HI;
        ...
        System.out.println(transactionsLevel);
    }
}

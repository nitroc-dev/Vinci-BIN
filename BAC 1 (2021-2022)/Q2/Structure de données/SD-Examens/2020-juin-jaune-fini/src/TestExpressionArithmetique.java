...
public class TestExpressionArithmetique {
	...
	public static void main(String[] args) {
		...
		do {
			System.out.println();
			System.out.println("1 -> Tester la methode nombreAdditions()");
	...
	private static void testnombreAdditions() {
		// TODO Auto-generated method stub
		ExpressionArithmetique exp1 = exp(1);
		assertEquals("test exp1 : ko",1,exp1.nombreAdditions());
		ExpressionArithmetique exp2 = exp(2);
		assertEquals("test exp2 ko",2,exp2.nombreAdditions());
		ExpressionArithmetique exp3 = exp(3);
		assertEquals("test exp3 ko",4,exp3.nombreAdditions());

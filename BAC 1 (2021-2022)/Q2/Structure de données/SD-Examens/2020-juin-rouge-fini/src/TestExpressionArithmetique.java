...
public class TestExpressionArithmetique {
	...
	private static void testNombreOperations() {
		...
		assertEquals("test exp1 : ko",1,exp1.nombreOperations('+'));
		ExpressionArithmetique exp2 = exp(2);
		assertEquals("test exp2 ko",2,exp2.nombreOperations('-'));
		assertEquals("test exp2 ko",0,exp2.nombreOperations('/'));
		ExpressionArithmetique exp3 = exp(3);
		assertEquals("test exp3 ko",4,exp3.nombreOperations('+'));
		try{
